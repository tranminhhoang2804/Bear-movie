...
class IndexController extends Controller
{
    public function timkiem(){
        if(isset($_GET['search'])){
            ...
            $movie = Movie::where('title','LIKE','%'.$search.'%')->orderBy('ngaycapnhat','DESC')->paginate(18);
    ...
    public function category($slug){
        ...
        $movie = Movie::withCount('episode')->where('category_id',$cate_slug->id)->orderBy('ngaycapnhat','DESC')->paginate(18);
    ...
    public function year($year){
        ...
        $year = $year;
        $movie = Movie::withCount('episode')->where('year',$year)->orderBy('ngaycapnhat','DESC')->paginate(18);
    ...
    public function tag($tag){
        ...
        $country = Country::orderBy('id','DESC')->get();
        $tag = $tag;
        $movie = Movie::withCount('episode')->where('tags','LIKE','%'.$tag.'%')->orderBy('ngaycapnhat','DESC')->paginate(18);
    ...
    public function genre($slug){
        ...
        $movie = Movie::withCount('episode')->whereIn('id',$many_genre)->orderBy('ngaycapnhat','DESC')->paginate(18);
    ...
    public function country($slug){
        ...
        $movie = Movie::withCount('episode')->where('country_id',$count_slug->id)->orderBy('ngaycapnhat','DESC')->paginate(18);
