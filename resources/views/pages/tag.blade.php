...
<div class="panel-heading container p-2">
            <div class="row">
            <div class="col-xs-6">
                <div class="yoast_breadcrumb hidden-xs"><span><span class="text-light">Danh mục » <a class="panel-heading-title text-light fw-bold" href="">Phim theo tags</a></span></span></div>
            </div>
            </div>
        </div>
        <div class="col-xs-12 movie-by-cate container">
            <section id="halim-advanced-widget-4">
               <div class="section-heading mt-2 mb-2 p-2">
                  ...
                  <span class="fw-bolder text-warning">Tags : {{$tag}}</span>
                  </a>
               </div>
