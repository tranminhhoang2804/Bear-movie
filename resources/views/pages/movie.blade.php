            ...
            <div class="col-6 film-title">
                <div class="film-poster">
                    ...
                    <ul class="list-info-group border-top pt-2">
                       ...
                       <li class="list-info-group-item text-warning"><span class="fw-bold text-light">So tap</span> : {{$movie->sotap}}/{{$movie->sotap}} - Complete</li>
                       ...
                       <li class="list-info-group-item text-warning">
                        @if($movie->resolution!=5)
                        <a class="bg-warning text-dark movie-button fw-bold p-2 m-2" href="{{route('watch',[$movie->slug])}}">Xem phim</a>
                        @else
