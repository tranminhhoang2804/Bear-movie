...
<div class="panel-heading container p-2">
        ...
        <div class="movie-detail d-flex justify-content-center m-5">
            <div class="col-2">
                <div class="movie-poster d-block">
                    <img class="movie-thumb" width="200px" src="{{asset('uploads/movie/'.$movie->image)}}" alt="{{$movie->title}}">
                 </div>
                 <div class="movie-watch container d-flex justify-content-center">
                    <a class="bg-warning text-dark movie-button fw-bold p-2 m-2" href="{{route('watch')}}">Xem phim</a>
                </div>
            </div>
            <div class="col-6">
                <div class="film-poster">
                    ...
                    <ul class="list-info-group">
                       ...
                       <li class="list-info-group-item text-warning"><span class="fw-bold text-light">Thể loại</span> : <a href="{{route('genre',[$movie->genre->slug])}}" rel="category tag">{{$movie->genre->title}}</a></li>
